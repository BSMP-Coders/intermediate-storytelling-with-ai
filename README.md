...
| ----------- | ----------- | ----------- | ----------- |
| 2.1 - Advanced AI Image and Text Generation |<ul><li>Evaluate and compare various AI image generation models to understand their respective strengths and appropriate use cases</li><li>Master advanced prompting techniques for creating compelling visual narratives with consistent style across multiple images</li><li>Learn to craft cohesive visual stories using Azure AI Image Creator, culminating in a sequence of 5+ related images</li></ul> | Build a branching narrative using Azure OpenAI Service | Design an interactive story with consistent characterization
| 2.2 - Azure OpenAI Service: Speech-to-Text Integration |<ul><li>Configure Azure Speech Service for optimal transcription</li><li>Implement real-time transcription in storytelling applications</li></ul> | Create an audio story transcription pipeline | Build a functioning speech-to-text storytelling tool
